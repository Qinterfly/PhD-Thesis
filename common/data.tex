...
\newcommand{\opponentOneJobPost}{первый заместитель заведующего кафедры <<Аэрокосмические системы>>}
...
\newcommand{\opponentTwoJobPost}{профессор кафедры <<Автоматические системы энергетических установок>>}
