...
\fixme{Дальше нужно переписать в соответствии с новыми формулами и делением внутреннее-внешнее. Где-то еще нужно написать про суперпозицию целевой/градиента при одновременной коррекции.}
