...
\usepackage{tikz}						  % Пакет векторной графики
\usetikzlibrary{shadows, arrows}          % Использование теней и стрелок в Tikz
\usetikzlibrary{positioning}              % Позиционирование в Tikz
