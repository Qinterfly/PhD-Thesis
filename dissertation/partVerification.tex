...
\begin{figure}[!htb]
	\centering
	\includegraphics[width = 0.75\textwidth]{perturbation-plate-distribution}
...
Корректируемые тона собственных колебаний характеризуется существенными смещениями солнечных панелей, в то время как орбитальный, возвращаемый и командно-сервисный модули остаются неподвижными. Это соотносится с характером распределения изменений узловых жесткостей, приведенных на рисунке~\ref{fig:perturbation-spacecraft-distribution}.
...
\fixme{Предваряя следующий раздел, нужно сказать о программной реализации: KLPCOR, KLPMRG, KLPEIG и KLPFREE. Краткое описание архитектуры. Более подробно об управляющих файлах для коррекции. Отметить универсальность комплекса при работе с разными КЭ-пакетами}
