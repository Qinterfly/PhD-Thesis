...
\fixme{Дальше нужно переписать в соответствии с новыми формулами и делением внутреннее-внешнее.}
...
\begin{equation*}
	\alpha_{i, j} = \abs{1 - \frac{f ^ \ast_{i, j}}{f_{i, j}}}, \ i = 1 \hdots s, \ j = 1 \hdots r,
\end{equation*}
