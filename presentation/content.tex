...
\begin{frame}{Сопоставление форм колебаний до и после коррекции}
	...
	\begin{columns}
		\begin{column}{0.49\textwidth}
			\centering
			\begin{figure}
				\fbox{\includegraphics[width=1\textwidth]{wing-MAC}}
			\end{figure}
		\end{column}
		\begin{column}{0.4\textwidth}
			\centering
			\begin{figure}
				\fbox{\includegraphics[width=1\textwidth]{wing-initial-mode-1}} \\ \vspace{0.2em}
				\fbox{\includegraphics[width=1\textwidth]{wing-initial-mode-2}} \\ \vspace{0.2em}
				\fbox{\includegraphics[width=1\textwidth]{wing-initial-mode-3}} \\ \vspace{0.2em}
				\fbox{\includegraphics[width=1\textwidth]{wing-initial-mode-4}}
			\end{figure}
		\end{column}
	\end{columns}
\end{frame}
